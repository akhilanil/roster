...
/* Label for email id */
export const EMAIL_ID_LABEL: string = 'Enter your email id';

/* Error label for EMAIL_ID_INVALID */
...
/* Label for button */
export const EMAIL_ID_HINT = 'Link to reset password will be sent to this mail id.'
